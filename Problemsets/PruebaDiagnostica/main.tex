...
{\Large Este set de problemas tiene 4 problemas, ennumerados de la página 1 a la \textbf{n}\par}
...
Salvo que se indique lo contrario, las siguientes condiciones se aplican a todos los problemas.

\subsection*{Nombre del Programa}

Su solución debe enviarse utilizando el nombre de archivo especificado por
la plataforma del concurso.

\subsection*{Entrada}

\begin{enumerate}[leftmargin=*]
    \item La entrada debe leerse desde la entrada estándar.
    \item La entrada consta de un único caso de prueba.
    \item Los valores que se encuentren en la misma línea están separados por espacios.
...
\begin{enumerate}[leftmargin=*]
    \item La salida debe escribirse en la salida estándar.
    \item El resultado debe imprimirse exactamente como se especifica.
    \item No debe aparecer ninguna salida adicional.
\end{enumerate}

\subsection*{Normas y Código de Honor}

La sesión tendrá una duración de \textbf{1 hora y 30 minutos} y se realizará en grupos de \textbf{máximo tres (3) personas}. Cada grupo deberá trabajar de manera colaborativa y respetar las siguientes normas durante toda la sesión.

\subsubsection*{Material y herramientas permitidas}

\begin{enumerate}[leftmargin=*]
    \item Se permite únicamente el uso de material de consulta \textbf{impreso}, como libros, apuntes, hojas de referencia o documentación impresa.
    
    \item También se permite consultar exclusivamente las siguientes páginas oficiales de documentación:
    \begin{itemize}
    ...
    \item \textbf{No está permitido consultar ninguna otra página web}, incluyendo buscadores, foros, blogs, repositorios de código, sitios de preguntas y respuestas o páginas con soluciones a problemas de programación.
    
    \item No está permitido utilizar teléfonos celulares, relojes inteligentes, audífonos, tabletas u otros dispositivos electrónicos personales. Estos deberán permanecer \textbf{guardados en la maleta durante toda la sesión}.
    
    \item No está permitido utilizar herramientas basadas en \textbf{modelos de lenguaje (LLM)}, asistentes de inteligencia artificial o cualquier otra herramienta de generación automática de código, incluyendo, entre otras, ChatGPT, GitHub Copilot, Gemini, Claude o herramientas equivalentes.
    
    \item El único entorno de desarrollo (IDE) permitido durante la prueba será \textbf{USACO Guide IDE}, disponible en \url{https://ide.usaco.guide/}.
    
    \item Los lenguajes de programación permitidos serán \textbf{C/C++, Java y Python}.
    
    \item No se permite utilizar otros IDE, editores de código, compiladores, intérpretes o herramientas de desarrollo diferentes a las proporcionadas por el entorno autorizado.
\end{enumerate}

\subsubsection*{Comunicación y colaboración}

\begin{enumerate}[leftmargin=*]
\item Los integrantes de cada grupo pueden discutir libremente los problemas, diseñar algoritmos, revisar código y tomar decisiones de manera conjunta.
\item Está prohibido recibir o proporcionar ayuda a personas que pertenezcan a otros grupos.
\item No está permitido compartir código, soluciones, algoritmos o fragmentos de código con otros grupos.
\item Las consultas al profesor estarán limitadas exclusivamente a preguntas relacionadas con \textbf{la forma de leer o interpretar los datos de entrada}. El profesor no proporcionará pistas sobre el algoritmo, la estrategia de solución, la complejidad esperada ni la respuesta de los problemas.
\item No está permitido solicitar al profesor que revise, corrija o valide una solución o un algoritmo.
\end{enumerate}

\subsubsection*{Código de Honor}

Al participar en esta prueba, cada integrante se compromete a:

\begin{enumerate}[leftmargin=*]
\item Resolver los problemas de manera honesta y utilizando únicamente los recursos permitidos.
\item No utilizar herramientas de inteligencia artificial, LLM, búsquedas en Internet, soluciones de terceros ni código obtenido de fuentes externas durante la sesión.
\item No comunicarse con personas externas al grupo para obtener ayuda relacionada con la prueba.
\item No observar, copiar o intentar obtener información de las soluciones o pantallas de otros grupos.
\item No compartir información sobre los problemas o sus soluciones con otros grupos durante la sesión.
\item Informar al profesor si se presenta alguna situación que pueda comprometer la integridad de la prueba.
\end{enumerate}

\subsubsection*{Condiciones de la sesión}

\begin{enumerate}[leftmargin=*]
\item El tiempo total disponible será de \textbf{90 minutos}. El tiempo comenzará cuando el profesor indique el inicio de la prueba y finalizará cuando se anuncie el término de la sesión.
\item Una vez finalizado el tiempo, ningún grupo podrá continuar modificando o ejecutando sus soluciones.
\item Cada grupo estará conformado por \textbf{máximo tres (3) integrantes}. No se permitirá la incorporación de nuevos integrantes una vez iniciada la prueba.
\item Cada grupo será responsable de administrar su tiempo y distribuir las tareas entre sus integrantes.
\item Los participantes deberán permanecer en el espacio asignado durante la prueba, salvo que el profesor autorice lo contrario.
\item Cualquier situación no contemplada explícitamente en estas normas será resuelta por el profesor, procurando preservar la igualdad de condiciones entre todos los grupos.
\end{enumerate}

\subsubsection*{Compromiso}

La participación en la prueba implica la aceptación de estas normas. Cualquier incumplimiento podrá resultar en la \textbf{anulación de la participación del grupo}, de acuerdo con la gravedad de la situación y la decisión del profesor. Además de ser reportado el caso al comité de convivencia de la facultad.

Al participar, los integrantes declaran que conocen y aceptan estas condiciones y se comprometen a mantener una conducta íntegra, respetuosa y colaborativa durante toda la sesión.
